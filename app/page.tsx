  ...
  return <div className="appShell">
    ...
    <div className="terminal shell">
      ...
      <main className="content" id="overview">
        ...
        <footer className="pageFooter"><strong>DuoData</strong><span>Independent market intelligence for TradFi on crypto exchanges.</span><span>V1.8 · Cross-venue Research Framework · Integrated Brokerage Access Index · Multi-venue Real Equity + Tokenized Spot + Perps</span></footer>
      </main>
    </div>
  </div>
}
